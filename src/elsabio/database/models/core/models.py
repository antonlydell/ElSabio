...
class SerieType(ModifiedAndCreatedColumnMixin, Base):
    ...
    external_id : int or None
        The unique external ID of the serie type. Is indexed.

    external_name : str or None
        The unique external name of the serie type. Is indexed.
...
Index(f'{SerieType.__tablename__}_external_name_uix', SerieType.external_name, unique=True)
